...
def main():
    ...
    df = pd.DataFrame(
        list(averages.items()), columns=['Date', "Team", "Average Fraction of Bankroll", 'Dexsports']
    )

    # Export the DataFrame to a CSV file
    df.to_csv("Export_File/average_fractions.csv", mode='a', index=False, header=False index=False)
